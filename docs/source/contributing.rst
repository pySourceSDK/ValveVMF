...
This will allow you to import valvevmf in other projects normally while being able to mess with the code directly from the git folder. This way, you can make sure valvevmf will work as intended in the context of your project.
